...
s2 = pd.Series(data=data, index=header, name='genome')
...
## Series Facts
- Has name, index, and data
- float64 supports NaN and int64 does not
- count ignores NaNs an None
- Int64 supports null values and int64 does not
